...
import { LabelIndex, PropertyIndex, TextIndex, VectorIndex, PatternIndex } from '../src/indexing/index.js';
import type { GraphPattern, PatternNode, PatternEdge } from '../src/indexing/pattern-index.js';
